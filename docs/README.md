...
Ce dossier contient la documentation synthétique du projet Quality Analysis.

## Fichiers

- `project-summary.md` : résumé métier et technique.
- `data-cleaning-strategy.md` : règles de nettoyage et limites.
